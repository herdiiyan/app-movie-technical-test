...
import { personDetails, personMovies as persMovies } from '../redux/actions';
...
export default function PersonScreen() {
    ...
    const personMovies = useSelector(data => data.personMovies);
